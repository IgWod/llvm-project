...
; RUN: llc -mtriple=amdgpu6.00 -amdgpu-s-branch-bits=4 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 -amdgpu-s-branch-bits=5 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX11 %s
; RUN: llc -mtriple=amdgpu12.00 -amdgpu-s-branch-bits=5 -simplifycfg-require-and-preserve-domtree=1 -amdgpu-long-branch-factor=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX12 %s


; FIXME: We should use llvm-mc for this, but we can't even parse our own output.
;        See PR33579.
; RUN: llc -mtriple=amdgpu6.00 -amdgpu-s-branch-bits=4 -amdgpu-long-branch-factor=0 -o %t.o -filetype=obj -simplifycfg-require-and-preserve-domtree=1 %s
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s6, s6, (.LBB3_2-.Lpost_getpc3)&4294967295
; GFX11-NEXT:    s_addc_u32 s7, s7, (.LBB3_2-.Lpost_getpc3)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s4, s4, (.LBB3_2-.Lpost_getpc3)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s5, s5, (.LBB3_2-.Lpost_getpc3)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
