...
; CGP-NEXT:    v_cvt_u32_f32_e32 v14, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v16, v15, 0
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[4:5]
; CGP-NEXT:    v_mul_hi_u32 v4, v15, v3
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v17, v15, v[10:11]
; CGP-NEXT:    v_mul_lo_u32 v10, v14, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v14, v3
; CGP-NEXT:    v_mul_lo_u32 v11, v15, v12
...
; CGP-NEXT:    v_mul_hi_u32 v9, v15, v3
; CGP-NEXT:    v_mul_lo_u32 v10, v15, v12
; CGP-NEXT:    v_xor_b32_e32 v13, v4, v16
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v9, v15, v12
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v10, v4
...
; CGP-NEXT:    v_xor_b32_e32 v12, v8, v16
...
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v3, v8
; CGP-NEXT:    v_mul_hi_u32 v10, v12, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v2, v14, 0
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v10, v8
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v2, v15, v[4:5]
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v13, v3
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v14, v[8:9]
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v12, v10, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, v9, v10, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v9, vcc, 1, v14
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, 0, v15, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v8, v1
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v2
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v1
; CGP-NEXT:    v_cndmask_b32_e32 v1, v11, v2, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, 1, v9
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CGP-NEXT:    v_cndmask_b32_e32 v1, v9, v2, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v2, v10, v3, vcc
...
; CGP-NEXT:    v_mov_b32_e32 v3, 0
; CGP-NEXT:    v_lshl_b64 v[8:9], v[2:3], v6
; CGP-NEXT:    v_mov_b32_e32 v2, 0
; CGP-NEXT:    v_or_b32_e32 v3, v7, v9
; CGP-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; CGP-NEXT:    ; implicit-def: $vgpr2_vgpr3
; CGP-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; CGP-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
...
; CGP-NEXT:    s_setpc_b64 s[30:31]
; CGP-NEXT:  .LBB8_7:
; CGP-NEXT:    v_ashrrev_i32_e32 v2, 31, v9
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v8, v2
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v9, v2, vcc
; CGP-NEXT:    v_xor_b32_e32 v4, v3, v2
...
; CGP-NEXT:  .LBB8_8:
; CGP-NEXT:    v_cvt_f32_u32_e32 v2, v8
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, 0, v8
; CGP-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; CGP-NEXT:    v_mul_f32_e32 v2, 0x4f7ffffe, v2
; CGP-NEXT:    v_cvt_u32_f32_e32 v2, v2
; CGP-NEXT:    v_mul_lo_u32 v3, v3, v2
...
; CGP-NEXT:    v_mov_b32_e32 v3, 0
; CGP-NEXT:    v_mul_lo_u32 v4, v2, v8
...
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v4, v8
; CGP-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, 1, v2
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v8
; CGP-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
