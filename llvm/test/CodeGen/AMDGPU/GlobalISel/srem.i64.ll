...
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v12, v[3:4]
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v15, v13, v[10:11]
; CGP-NEXT:    v_mul_hi_u32 v4, v13, v2
; CGP-NEXT:    v_mul_lo_u32 v10, v12, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v12, v2
; CGP-NEXT:    v_mul_lo_u32 v11, v13, v3
...
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v17
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v10, v13, v3
; CGP-NEXT:    v_xor_b32_e32 v11, v4, v14
; CGP-NEXT:    v_mul_lo_u32 v4, v12, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v12, v2
...
; CGP-NEXT:    v_mul_hi_u32 v4, v11, v2
; CGP-NEXT:    v_mul_lo_u32 v9, v11, v3
; CGP-NEXT:    v_xor_b32_e32 v10, v8, v14
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v8, v11, v3
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v9, v4
...
; CGP-NEXT:    v_mul_hi_u32 v9, v10, v3
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v0, v12, 0
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v8, v4
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v9, v4
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v4, v[3:4]
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v11, v2
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v1, v12, v[8:9]
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v8, v3
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, v9, v3, vcc
; CGP-NEXT:    v_xor_b32_e32 v2, v2, v3
; CGP-NEXT:    v_xor_b32_e32 v3, v4, v3
; CGP-NEXT:    v_cvt_f32_u32_e32 v4, v2
...
; CGP-NEXT:    v_mov_b32_e32 v3, 0
; CGP-NEXT:    v_mul_lo_u32 v2, v2, v8
