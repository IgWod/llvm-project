...
; GFX8GISEL-NEXT:    s_brev_b32 s2, 1
...
; GFX8GISEL-NEXT:    s_max_i32 s2, s2, s6
...
; GFX9GISEL-NEXT:    s_brev_b32 s2, 1
...
; GFX9GISEL-NEXT:    s_max_i32 s2, s2, s6
...
; GFX1064GISEL-NEXT:    s_brev_b32 s2, 1
...
; GFX1064GISEL-NEXT:    s_max_i32 s2, s2, s6
...
; GFX1032GISEL-NEXT:    s_max_i32 s0, s0, s3
...
; GFX1164GISEL-NEXT:    s_bitset0_b64 s[0:1], s3
; GFX1164GISEL-NEXT:    s_max_i32 s2, s2, s6
; GFX1164GISEL-NEXT:    s_cmp_lg_u64 s[0:1], 0
...
; GFX6DAGISEL:       ; %bb.0: ; %entry
; GFX6DAGISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6DAGISEL-NEXT:    s_mov_b32 s4, 0
; GFX6DAGISEL-NEXT:    s_brev_b32 s5, 1
...
; GFX6DAGISEL-NEXT:    v_cmp_gt_i64_e32 vcc, s[8:9], v[4:5]
...
; GFX7DAGISEL:       ; %bb.0: ; %entry
; GFX7DAGISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7DAGISEL-NEXT:    s_mov_b32 s4, 0
; GFX7DAGISEL-NEXT:    s_brev_b32 s5, 1
...
; GFX7DAGISEL-NEXT:    v_cmp_gt_i64_e32 vcc, s[8:9], v[4:5]
